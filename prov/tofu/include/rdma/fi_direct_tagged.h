...
extern ssize_t	tofu_ctx_tag_recvv(struct fid_ep *fid_ep, const struct iovec *iov,
				   ...
				   uint64_t tag, uint64_t ignore, void *context);
extern ssize_t	tofu_ctx_tag_recvmsg(struct fid_ep *fid_ep, const struct fi_msg_tagged *msg, uint64_t flags);
extern ssize_t	tofu_ctx_tag_send(struct fid_ep *fid_ep, const void *buf, size_t len,
				  void *desc, fi_addr_t dest_addr,  uint64_t tag, void *context);
extern ssize_t	tofu_ctx_tag_sendv(struct fid_ep *fid_ep, const struct iovec *iov,  void **desc, size_t count,
				   fi_addr_t dest_addr, uint64_t tag, void *context);
extern ssize_t	tofu_ctx_tag_sendmsg(struct fid_ep *fid_ep, const struct fi_msg_tagged *msg, uint64_t flags);
extern ssize_t	tofu_ctx_tag_senddata(struct fid_ep *fid_ep,  const void *buf,  size_t len, void *desc,
				      uint64_t data, fi_addr_t dest_addr, uint64_t tag, void *context);
extern ssize_t	tofu_ctx_tag_inject(struct fid_ep *fid_ep, const void *buf, size_t len, fi_addr_t dest_addr, uint64_t tag);
...
extern ssize_t	tofu_ctx_tag_injectdata(struct fid_ep *fid_ep, const void *buf, size_t len, uint64_t data,
...
{
    return tofu_ctx_tag_recvmsg(ep, msg, flags);
}
...
fi_tsend(struct fid_ep *ep, const void *buf, size_t len, void *desc,
	 fi_addr_t dest_addr, uint64_t tag, void *context)
{
    return tofu_ctx_tag_send(ep, buf, len, desc, dest_addr, tag, context);
}
...
{
    return tofu_ctx_tag_sendv(ep, iov, desc, count, dest_addr,tag, context);
}

static inline ssize_t
fi_tsendmsg(struct fid_ep *ep, const struct fi_msg_tagged *msg, uint64_t flags)
{
    return tofu_ctx_tag_sendmsg(ep, msg, flags);
}
...
fi_tinject(struct fid_ep *ep, const void *buf, size_t len,
	   fi_addr_t dest_addr, uint64_t tag)
{
    return tofu_ctx_tag_inject(ep, buf, len, dest_addr, tag);
}
...
fi_tsenddata(struct fid_ep *ep, const void *buf, size_t len, void *desc,
	     uint64_t data, fi_addr_t dest_addr, uint64_t tag, void *context)
{
    return tofu_ctx_tag_senddata(ep, buf, len, desc, data, dest_addr, tag, context);
}
...
{
    return tofu_ctx_tag_injectdata(ep, buf, len, data, dest_addr, tag);
}
